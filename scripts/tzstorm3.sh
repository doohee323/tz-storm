...
echo 'tzstorm.test.com=zookeeper1:2888:3888' >> config/zookeeper.properties
echo 'tzstorm2.test.com=zookeeper2:2888:3888' >> config/zookeeper.properties
echo 'tzstorm3.test.com=zookeeper3:2888:3888' >> config/zookeeper.properties
