...
echo '192.168.82.150 core.proxy.xdn.com' >> /etc/hosts
echo '192.168.82.150 fapi.proxy.xdn.com' >> /etc/hosts
echo '192.168.82.150 api.proxy.xdn.com' >> /etc/hosts
...
echo '' >> conf/zoo.cfg
echo 'core.proxy.xdn.com=zookeeper1:2888:3888' >> conf/zoo.cfg
echo 'fapi.proxy.xdn.com=zookeeper2:2888:3888' >> conf/zoo.cfg
echo 'api.proxy.xdn.com=zookeeper3:2888:3888' >> conf/zoo.cfg
...
echo '    - "core.proxy.xdn.com"' >> conf/storm.yaml
echo '    - "fapi.proxy.xdn.com"' >> conf/storm.yaml
echo '    - "api.proxy.xdn.com"' >> conf/storm.yaml
...
storm jar $HOME/$PROJ_NAME/$PROJ_NAME-$VERSION.jar example.tzstorm.TestTopology TestTopology
#storm list
#storm deactivate TestTopology
